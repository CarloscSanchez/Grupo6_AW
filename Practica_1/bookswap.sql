...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-03-2025 a las 11:59:08
...
--
CREATE DATABASE IF NOT EXISTS `bookswap` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bookswap`;
...
('root', '[{\"db\":\"bookswap\",\"table\":\"intercambios\"}]');
...
('root', '2025-03-03 10:51:58', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
