...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2025 a las 18:17:31
...
(2, 'ERIK VOGLER 2: Muerte en el balneario', 'Beatriz Osés', 'Misterio', 'Edebé', 'Español', 'bueno', 'Erik Vogler viaja a un balneario para relajarse, pero las vacaciones se complican cuando empiezan a ocurrir misteriosas muertes y él debe resolver el caso antes de que sea demasiado tarde.', 'img/erik-vogler-2.jpg', 1, 1, '2025-03-07'),
(3, 'Soldados de Salamina', 'Javier Cercas', 'Histórico', 'Tusquets Editores', 'Español', 'nuevo', 'Hacia el final de la guerra civil se produjo, cerca de la frontera con Francia, un fusilamiento de prisioneros franquistas. Uno de ellos escapó con vida, gracias a un joven soldado republicano, y se pudo refugiar en el bosque. Se trataba de Rafael Sánchez Mazas, poeta, fundador de Falange y futuro ministro de Franco.', 'img/soldados-de-salamina.png', 2, 1, '2025-03-07'),
(4, 'La sombra del viento', 'Carlos Ruíz Zafón', 'Misterio', 'Planeta', 'Español', 'bueno', 'La trama se desenvuelve en una embrujada Barcelona donde, junto a su nuevo amigo Fermín, intentará descubrir la verdad que envuelve a un enigmático ser que a toda costa intenta enterrar el pasado de Julián Carax. ​ Una novela de suspenso que intenta mezclar lo real con la fantasía, el misterio con el amor.', 'img/la-sombra-del-viento.jpeg', 2, 1, '2025-03-07'),
(5, 'La isla de la mujer dormida', 'Arturo Pérez-Reverte', 'Histórico', 'Alfaguara', 'Español', '', 'En plena Guerra Civil Española, un marino se embarca en una peligrosa misión en el mar Egeo, donde el amor y la traición acechan entre las olas.', 'img/la-isla-de-la-mujer-dormida.jpg', 1, 1, '2025-03-07');
